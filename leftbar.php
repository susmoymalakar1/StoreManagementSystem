<h5 class="bg-success text-white px-2 py-1" >Category</h5>
                    ...
                    <ul class="list-group m-2">
                        ...
                        <li class="list-group-item"><a href="list_of_store_product.php" class="text-dark text-decoration-none">Store product List</a></li>
                    </ul>

                    <h5 class="bg-success text-white px-2 py-1" >Spend Product</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item"><a href="add_spend_product.php" class="text-dark text-decoration-none">Add Spend Product</a></li>
                    ...
                    <ul class="list-group m-2">
                        <li class="list-group-item"><a href="add_users.php" class="text-dark text-decoration-none">Add User</a></li>
                        <li class="list-group-item"><a href="list_of_users.php" class="text-dark text-decoration-none">User's List</a></li>
                    </ul>