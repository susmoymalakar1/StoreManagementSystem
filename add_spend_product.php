...
<div class="container bg-light">
        ...
        if(isset($_GET['spend_product_name']))
        {
            ...
            if($connection->query($sql)==TRUE){
                echo "<script>alert('Record insert successfully')</script>";
                        ?>
                        <meta http-equiv="refresh" content="0; url=http://localhost/storeMS/add_spend_product.php"/><!-- content means time koto secend e refresh hobe-->
                        <?php
            }
            else{
    ...
    <div class="container1">
        <form action="add_spend_product.php" method="GET" class="form-control w-50 bg-secondary text-white">
        <h3 class='text-center'>Add Spend Product</h3>
        Product :<br/>
        <select name="spend_product_name" class="form-control mb-3">
        <?php
        ...
        Product Quentity :<br/>
        <input type="text" name="spend_product_quentity" class="form-control mb-3"><br><br>
        Spend Entry Date :<br>
        <input type="date" name="spend_product_entry_date" class="form-control mb-3"><br><br>
