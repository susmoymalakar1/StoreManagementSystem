        ...
        <div class="container-foulid">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 border-start border-success"><!--right bar-->
                    ...
                    <?php
                        $sql1="SELECT * FROM spend_product";
                        ...
                        $sql="SELECT * FROM spend_product LIMIT 5 OFFSET $offset";
                        ...
                        while($data=mysqli_fetch_assoc($query))
                        {
                            ...
                            <td>
                                <a href='edit_spend_product.php?id=$spend_product_id & name=$spend_product_name & quentity=$spend_product_quentity & date=$spend_product_entry_date' class='btn btn-success' onclick='return checkupdate()'>Edit</a>
                                <a href='delete_spend_product.php?id=$spend_product_id & name=$spend_product_name' class='btn btn-danger' onclick='return checkdelete()'>Delete</a>
                            </td>
                            </tr>";
                        }
                            echo "</table>";
                ...
                <?php
                    ...
                    {
                        echo " <a href='list_of_spend_product.php?pageno= $pagenum_decrement'>
                            <span class='bg-success text-white py-2 px-3 m-2'> < </span>
                        </a>";
                    }
                    ...
                    for($x=1;$x<$divided_num_rows;$x++)
                    {
                        ...
                        else
                        {
                            ...
                            <a href='list_of_spend_product.php?pageno=$x' class='text-white'> $x </a>
                            </span>";
                        }
                    }
                    ...
                    {
                        echo "<a href='list_of_spend_product.php?pageno= $pagenum_increment'>
                    <span class='bg-success text-white py-2 px-3 m-2'> > </span>
                    </a>"; 
                    }
                ...
                ?>
                    ...
                    <div class="print text-center">
                        <a href="print_spend_product.php" ><button class='btn btn-success' onclick='return checkprint()'>
                                    Print
                            </button></a>
                    </div>
